...
<%
    ...
    else if(request.getParameter("page").equals("news"))
    {
      ...
      {
         out.print("<script>alert('News is not added'); window.;loaction.href='news.jsp'</script>"); 
      }
    }
    else if(request.getParameter("page").equals("book"))
    {
        ...
        else
        {
          ...
          if(dm.insertUpdateDelete(query)==true)
          {
              out.print("<script>alert('Payment is Successful'); window.location.href='closing.jsp'</script>");
          }
          else
          {
              out.print("<script>alert('Payment is unsuccessful'); window.location.href='closing.jsp'</script>");
          }
          }
%>